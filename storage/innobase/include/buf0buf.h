...
#define buf_page_get(ID, SIZE, LA, MTR)					\
	buf_page_get_gen(ID, SIZE, LA, BUF_GET, MTR)
...
#define buf_page_get_with_no_latch(ID, SIZE, MTR)	\
	buf_page_get_gen(ID, SIZE, RW_NO_LATCH, BUF_GET_NO_LATCH, MTR)
/********************************************************************//**
...
public:
  ...
  /** broadcast when a page is written; protected by mutex */
  pthread_cond_t done_flush_page;
